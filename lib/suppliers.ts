...
export const SUPPLIERS: Record<SupplierPlatform, SupplierMeta> = {
  ...
  dhgate: {
    id: 'dhgate',
    label: 'DHGate',
    shippingDays: '7–20 days',
    avgMargin: '45–75%',
    minOrder: 1,
    searchUrl: 'https://www.dhgate.com/wholesale/search.do?key=',
  },
  banggood: {
    id: 'banggood',
    label: 'Banggood',
    shippingDays: '10–25 days',
    avgMargin: '40–70%',
    minOrder: 1,
    searchUrl: 'https://www.banggood.com/search.html?SearchText=',
  },
  geek: {
    id: 'geek',
    label: 'Geek',
    shippingDays: '5–15 days',
    avgMargin: '35–65%',
    minOrder: 1,
    searchUrl: 'https://www.geek.com/search.html?q=',
  },
  wish: {
    id: 'wish',
    label: 'Wish',
    shippingDays: '14–40 days',
    avgMargin: '60–85%',
    minOrder: 1,
  ...
  shein: {
    ...
    avgMargin: '50–75%',
    minOrder: 1,
    searchUrl: 'https://www.shein.com/Search.html?q=',
  },
  lightinthebox: {
    id: 'lightinthebox',
    label: 'LightInTheBox',
    ...
    avgMargin: '40–70%',
    minOrder: 1,
    searchUrl: 'https://www.lightinthebox.com/en/search/',
  },
  miniinthebox: {
    id: 'miniinthebox',
    label: 'MiniInTheBox',
    ...
    avgMargin: '40–70%',
    minOrder: 1,
    searchUrl: 'https://www.miniinthebox.com/en/search/',
  },
  tomtop: {
    id: 'tomtop',
    label: 'TomTop',
    ...
    avgMargin: '35–65%',
    minOrder: 1,
    searchUrl: 'https://www.tomtop.com/search/',
  },
  newfrog: {
    id: 'newfrog',
    label: 'NewFrog',
    ...
    avgMargin: '45–70%',
    minOrder: 1,
    searchUrl: 'https://www.newfrog.com/search?keywords=',
  },
  shopify: {
    id: 'shopify',
    label: 'Shopify',
    shippingDays: '2–7 days',
    avgMargin: '25–50%',
    minOrder: 1,
    searchUrl: 'https://www.shopify.com/search/suppliers?q=',
  },
  woocommerce: {
    id: 'woocommerce',
    label: 'WooCommerce',
    shippingDays: '2–10 days',
    avgMargin: '30–60%',
    minOrder: 1,
    searchUrl: 'https://www.woocommerce.com/products/?s=',
  },
  buymeonce: {
    id: 'buymeonce',
    label: 'BuyMeOnce',
    ...
    avgMargin: '20–45%',
    minOrder: 1,
    searchUrl: 'https://www.buymeonce.com/search?q=',
  },
}
